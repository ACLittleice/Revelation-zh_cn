...
vec3 GetTransmittanceToTopAtmosphereBoundary(
    ...
    float mu
        ...
        return vec3(textureLod(transmittanceLut, uv, 0.0));
}
...
vec3 GetIrradiance(
    ...
    float mu_s
        ...
        return vec3(textureLod(irradianceLut, uv, 0.0));
}
...
vec3 GetSkyRadianceToPoint(
    ...
    out vec3 transmittance
        ...
        vec3 mie = sun_single_mie_scattering * AerosolPhase(nu)
                + moon_single_mie_scattering * AerosolPhase(-nu) * moonlightMult;
...
vec3 GetSkyRadiance(
    ...
    out vec3 transmittance
        ...
        transmittance = ray_r_mu_intersects_ground ? vec3(0.0) : GetTransmittanceToTopAtmosphereBoundary(r, mu);
            ...
            ray_r_mu_intersects_ground = ray_r_mu_intersects_ground && (r > planetRadius + 1e3);
        #endif
